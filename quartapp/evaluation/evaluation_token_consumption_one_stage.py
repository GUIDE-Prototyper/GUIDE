...
results = []
for elem in data:
    result = loop.run_until_complete(recommendation.recommendation_no_prototype_text_tokens(text=elem['prototype'], user_stories=elem['user_stories']))
...
with open(path_results + "one_stage_results.json", 'w') as file:
